...
public class Delta extends BaseDriver
{
	...
	public String reportFolderPath="./report/";
	...
	public static String imageFolderPath="./screenShots";
	public ExtentReports EReports;
	public ExtentTest ETest;
	public WebDriver driver;
	public String chromeDriverPath="./driver/chromedriver.exe";
	public static String  ActualImageFolder="./ActualImage";
	public static String  ExpectedImageFolder="./ExpectedImage";
 ...
 public void MultipleLoginActitime(String ScenarioSheet, String ExecutionStatus) throws InterruptedException
 {
	 ...
	 if(ExecutionStatus.equalsIgnoreCase("Yes"))
	 {
		 ...
		 for(int k=0;k<=rcount2;k++)
		 {
			 ...
			 String ElementRepo = Excel_Transactions.getCellValue(ScrenarioPath, ScenarioSheet, k, 2);
			 String input = Excel_Transactions.getCellValue(ScrenarioPath, ScenarioSheet, k, 3);
			 String Msg  = " description:" + Desc + "   Action:  "+ Action    + "   ElementRepo:   " +  ElementRepo +  "   Input :" + input;
			 Reporter.log(Msg, true);
			 ETest.log(LogStatus.INFO, Msg);
			 KeyWord.ExecuteKeyWord(driver, Action, ElementRepo, input, ETest);
			 //Assert.fail();
		 }
	 }
	 ...
	 /*if(ETest.getRunStatus()==LogStatus.FAIL)
		{
			Assert.fail();
		}*/
